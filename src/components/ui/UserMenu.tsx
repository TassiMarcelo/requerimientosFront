...
const UserMenu: React.FC<UserMenuProps> = ({ userName }) => {
  ...
  return (
    ...
    {showLogout && (
      ...
      className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-gray-700 text-white shadow hover:bg-gray-600 hover:text-white h-10 px-4 py-2"
      >
        Cerrar sesión
      </button>
    )}
